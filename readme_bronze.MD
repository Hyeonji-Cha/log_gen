...
- 명령
- 25건 로그 생성
- cloudwatch 로그 기록됨(stdout설정이 기본)
- kinesis-> firehose-> s3기록됨 (ecs 설정에 환경변수로 세팅되어 있음)
- s3에서 로그 발생후 언제확인 가능한가? -> 약간의 텀 있음, 1분 후 혹은 1Mib 초과이후 확인 가능함
